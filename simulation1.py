...
if __name__ == '__main__':
    ...
    router_a = network1.Router(name='A', 
                              intf_cost_L=[1,1], 
    ...
    router_b = network1.Router(name='B', 
                              intf_cost_L=[1,3], 
    ...
    #add all the links
    link_layer.add_link(link1.Link(client, 0, router_a, 0))
    link_layer.add_link(link1.Link(router_a, 1, router_b, 0))
    link_layer.add_link(link1.Link(router_b, 1, server, 0))
